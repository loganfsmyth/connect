  ...
  return function(req, res, next){
    ...
    function createToken(secret) {
      ...
      Object.defineProperty(req.session, '_csrf', {
        configurable: true,
        get: function() {
          if (!~JSON.stringify.toString().indexOf('native code'))
            console.warn('JSON.stringify overwritten: ' + JSON.stringify.toString());
          console.trace('req.session._csrf is deprecated, use req.csrfToken() instead');
